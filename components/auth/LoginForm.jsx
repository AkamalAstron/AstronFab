  ...
  async function onSubmit(data) {
    try {
      ...
      if (loginData.error) {
        ...
        if (loginData.error === "User not active. Please contact administrator") {
          toast.error("User not active. Please contact administrator");
        } else {
          toast.error("Login failed. Check your credentials.");
        }
      } else {
        // Redirect only if loginData has no error
        router.push("/dashboard/home/overview");
      }
    } catch (error) {
      toast.error("It seems something is wrong with your network or server.");
    } finally {
